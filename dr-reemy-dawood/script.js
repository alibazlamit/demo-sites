// ============================================================
// عيادة الدكتورة ريمي داود — interactions
// ============================================================
...
if (navToggle && hdr) {
  navToggle.addEventListener("click", function () { hdr.classList.toggle("open"); });
...
function sendToWhatsApp(e) {
  ...
  var lines = [
    "مرحباً، أرغب بحجز موعد في عيادة الدكتورة ريمي داود لطب الأسنان.",
    "الاسم: " + name,
    "الهاتف: " + phone,
    "الخدمة: " + service
  ];
