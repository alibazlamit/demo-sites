...
if (burger && hdr) {
  burger.addEventListener("click", function () { hdr.classList.toggle("open"); });
  var navLinks = hdr.querySelectorAll(".nav a");
...
function sendToWhatsApp(e) {
  ...
  var lines = [
    "مرحباً، أرغب بحجز موعد في عيادة الدكتور منجد سلامة.",
